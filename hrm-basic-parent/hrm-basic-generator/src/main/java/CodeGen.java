...
public class CodeGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/hrm/wyg/domain/" + tableInfo.getEntityName() + StringPool.DOT_JAVA;
            }
        });
        //query自定义生成路径
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/hrm/wyg/query/" + tableInfo.getEntityName() + "Query" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + properties.getProperty("mapperOutputDir")+ "/hrm/wyg/mapper/"
